...
# UJG TR 1.0 RC2 Modeling Agent Instructions

Use these instructions for whole UJG document modeling across Core, Graph, Surface and Experience, Runtime, Mapping, Metrics, Localization, Observability, Experience Annotation, and optional modules in Technical Report 1.0 RC2.
