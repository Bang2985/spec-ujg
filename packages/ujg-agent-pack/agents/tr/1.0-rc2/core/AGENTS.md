...
# UJG TR 1.0 RC2 Core Modeling Agent Instructions

Use these instructions for Core module document containers, imports, top-level nodes, and extensions in Technical Report 1.0 RC2.
