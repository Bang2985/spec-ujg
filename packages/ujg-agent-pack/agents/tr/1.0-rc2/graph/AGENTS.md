...
# UJG TR 1.0 RC2 Graph Modeling Agent Instructions

Use these instructions for Graph module topology, journeys, states, transitions, exits, outgoing navigation, and indexes in Technical Report 1.0 RC2.
