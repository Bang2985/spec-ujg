...
# UJG TR 1.0 RC2 Domain Model Implementation Conformance Agent Instructions

Use these instructions for software implementation conformance against a full UJG document with the Domain Model Document Extension, including domain behavior, guarded branches, effects, invariants, and journey semantics in Technical Report 1.0 RC2.
