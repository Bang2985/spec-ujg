...
# UJG TR 1.0 RC2 Localization Modeling Agent Instructions

Use these instructions for Localization module semantics for MessageMeta copy metadata, addressable Message values, Locale resources, and locale-switch metadata in Technical Report 1.0 RC2.
