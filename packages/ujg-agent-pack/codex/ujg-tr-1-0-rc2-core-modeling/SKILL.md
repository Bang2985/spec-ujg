---
name: ujg-tr-1-0-rc2-core-modeling
description: "Generate, review, correct, and reason about Core Modeling in User Journey Graph JSON-LD for the Technical Report 1.0 RC2. Use when the task is scoped to Core module document containers, imports, top-level nodes, and extensions or when whole-document modeling crosses this module boundary."
---
