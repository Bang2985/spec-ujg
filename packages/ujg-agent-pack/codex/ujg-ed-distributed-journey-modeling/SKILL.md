...
description: "Generate, review, correct, and reason about Distributed Journey Modeling in User Journey Graph JSON-LD for the Editor's Draft. Use when the task is scoped to Distributed Journey module semantics for cross-touchpoint human-facing journeys, distributed artifacts, and touchpoint references or when whole-document modeling crosses this module boundary."
---
...
- ujg-ed-modeling: whole UJG document modeling across Core, Graph, Surface, Runtime, Mapping, Metrics, and optional modules
