---
name: ujg-tr-1-0-rc2-domain-model-implementation
description: "Review or implement software against a User Journey Graph document with a Domain Model extension for the UJG 1.0 RC2 snapshot, preserving domain behavior, guarded branches, effects, invariants, and journey semantics. Use when the full UJG document is the behavioral source of truth; do not use to evaluate the DomainModel JSON alone."
---

<!-- Generated by @openuji/ujg-agent-pack. Do not edit directly. -->

# UJG TR 1.0 RC2 Domain Model Implementation Conformance
