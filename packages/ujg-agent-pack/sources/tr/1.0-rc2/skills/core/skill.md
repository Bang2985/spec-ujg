...
`https://ujg.specs.openuji.org/tr/1.0-rc2/core`

Generate only terms defined by the UJG 1.0 RC2 Core context unless the user explicitly requests an extension.
