# UJG TR 1.0 RC2 Graph Modeling Skill

Use this skill when the task is specifically about Graph vocabulary for the UJG 1.0 RC2 snapshot.

## Source of truth

Use the frozen UJG 1.0 RC2 Graph module:

`https://ujg.specs.openuji.org/tr/1.0-rc2/graph`

Treat `/tr/1.0-rc2` as frozen. Do not silently mix active ED terms with this release-candidate snapshot.
...
least one value. Do not use the legacy singular child-journey field in this snapshot's JSON-LD.
