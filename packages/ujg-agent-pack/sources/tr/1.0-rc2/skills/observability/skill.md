# UJG TR 1.0 RC2 Observability Modeling

Use this skill together with `ujg-tr-1-0-rc2-modeling`. Do not use it as a replacement for the parent modeling skill.

## Source of truth

Use the frozen UJG 1.0 RC2 snapshot unless the user explicitly asks for another version:

`https://ujg.specs.openuji.org/tr/1.0-rc2/modules/observability`

Generate only terms defined by the UJG 1.0 RC2 Observability context and required bridge modules unless the user explicitly requests an extension.
