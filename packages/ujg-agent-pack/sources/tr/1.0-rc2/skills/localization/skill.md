# UJG TR 1.0 RC2 Localization Modeling
...
`https://ujg.specs.openuji.org/tr/1.0-rc2/modules/l10n`

Generate only terms defined by the UJG 1.0 RC2 Localization context unless the user explicitly requests an extension.
...
* Are all l10n terms defined by the TR 1.0 RC2?
