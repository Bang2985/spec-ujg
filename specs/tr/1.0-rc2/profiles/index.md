...
The [Optional Modules](/tr/1.0-rc2#optional-modules) published in this release candidate are the official
...
Profiles MUST NOT treat those archived packages as active capabilities of this snapshot.
...
This release candidate does not define a JSON-LD property for profile declarations. Documents MAY contain
...
The `#core` profile requires [UJG Core](/tr/1.0-rc2/core). It is suitable for tools that exchange UJG document
...
The `#graph` profile requires [UJG Core](/tr/1.0-rc2/core) and [UJG Graph](/tr/1.0-rc2/graph). It is suitable for tools that exchange
...
The `#surface-runtime` profile requires [UJG Core](/tr/1.0-rc2/core), [UJG Graph](/tr/1.0-rc2/graph), [UJG Surface](/tr/1.0-rc2/surface),
and [UJG Runtime](/tr/1.0-rc2/runtime). It is suitable for tools that connect runtime observations to
graph-facing surfaces.

### Mapping Metrics {data-cop-concept="mapping-metrics"}

The `#mapping-metrics` profile requires [UJG Core](/tr/1.0-rc2/core), [UJG Graph](/tr/1.0-rc2/graph), [UJG Surface](/tr/1.0-rc2/surface),
[UJG Runtime](/tr/1.0-rc2/runtime), [UJG Mapping](/tr/1.0-rc2/mapping), and [UJG Metrics](/tr/1.0-rc2/metrics). It is suitable for
...
The `#localized-observability` profile requires [UJG Core](/tr/1.0-rc2/core), [UJG Graph](/tr/1.0-rc2/graph),
[UJG Surface](/tr/1.0-rc2/surface), [UJG Localization](/tr/1.0-rc2/modules/l10n), and
[UJG Observability](/tr/1.0-rc2/modules/observability). It is suitable for tools that recognize surface
...
The `#design-system` profile requires [UJG Core](/tr/1.0-rc2/core), [UJG Graph](/tr/1.0-rc2/graph),
[UJG Surface](/tr/1.0-rc2/surface), and [UJG Design System](/tr/1.0-rc2/modules/design-system). It is suitable for
...
The `#automation-resources` profile requires [UJG Core](/tr/1.0-rc2/core), [UJG Graph](/tr/1.0-rc2/graph),
[UJG Surface](/tr/1.0-rc2/surface), [UJG Phase](/tr/1.0-rc2/modules/phase),
[UJG Observability](/tr/1.0-rc2/modules/observability), [UJG Entry Binding](/tr/1.0-rc2/modules/entry-binding),
[UJG Effect](/tr/1.0-rc2/modules/effect), and [UJG Artifact](/tr/1.0-rc2/modules/artifact), including the dependency
