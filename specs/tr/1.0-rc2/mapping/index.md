...
```json
{
  "@context": [
    ...
    "https://ujg.specs.openuji.org/tr/1.0-rc2/ns/phase.context.jsonld",
    "https://ujg.specs.openuji.org/tr/1.0-rc2/ns/mapping.context.jsonld"
  ],
  "@type": "UJGDocument",
  "nodes": [
    {
...
`https://ujg.specs.openuji.org/tr/1.0-rc2/ns/mapping`.
...
`https://ujg.specs.openuji.org/tr/1.0-rc2/ns/mapping.shape`.
