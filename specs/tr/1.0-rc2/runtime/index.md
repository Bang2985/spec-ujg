...
- `runtime.ttl`: ontology, published at `https://ujg.specs.openuji.org/tr/1.0-rc2/ns/runtime`
- `runtime.context.jsonld`: JSON-LD term mappings, published at `https://ujg.specs.openuji.org/tr/1.0-rc2/ns/runtime.context.jsonld`
- `runtime.shape.ttl`: SHACL validation rules, published at `https://ujg.specs.openuji.org/tr/1.0-rc2/ns/runtime.shape`

Examples in this page use an explicit context array composed from the published module contexts. The same composition is also published as the convenience context `https://ujg.specs.openuji.org/tr/1.0-rc2/ns/context.jsonld`.

### Ontology {data-cop-concept="ontology"}

The normative Runtime ontology is defined below and is published at `https://ujg.specs.openuji.org/tr/1.0-rc2/ns/runtime`. It is the authoritative structural definition for `JourneyExecution`, `RuntimeEvent`, and the properties that connect them.

:::include ./runtime.ttl :::

### JSON-LD Context {data-cop-concept="jsonld-context"}

The normative Runtime JSON-LD context is defined below and is published at `https://ujg.specs.openuji.org/tr/1.0-rc2/ns/runtime.context.jsonld`. It provides the compact JSON-LD term mappings for Runtime examples, including IRI-valued references and opaque JSON `payload` values.
...
The normative Runtime SHACL shape is defined below and is published at `https://ujg.specs.openuji.org/tr/1.0-rc2/ns/runtime.shape`. It is the authoritative validation artifact for Runtime structural constraints.
...
```json
{
  "@context": "https://ujg.specs.openuji.org/tr/1.0-rc2/ns/context.jsonld",
