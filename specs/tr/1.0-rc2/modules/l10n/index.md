...
- `l10n.ttl`: ontology, published at `https://ujg.specs.openuji.org/tr/1.0-rc2/ns/l10n`
- `l10n.context.jsonld`: JSON-LD term mappings, published at `https://ujg.specs.openuji.org/tr/1.0-rc2/ns/l10n.context.jsonld`
- `l10n.shape.ttl`: SHACL validation rules, published at `https://ujg.specs.openuji.org/tr/1.0-rc2/ns/l10n.shape`
...
`https://ujg.specs.openuji.org/tr/1.0-rc2/ns/l10n`. It is the authoritative structural definition for
...
`https://ujg.specs.openuji.org/tr/1.0-rc2/ns/l10n.context.jsonld`. It provides the compact JSON-LD term
...
`https://ujg.specs.openuji.org/tr/1.0-rc2/ns/l10n.shape`. It is the authoritative validation artifact for
