...
The Phase ontology is published at `https://ujg.specs.openuji.org/tr/1.0-rc2/ns/phase`.

:::include ./phase.ttl :::

### JSON-LD Context {data-cop-concept="jsonld-context"}

The Phase context is published at `https://ujg.specs.openuji.org/tr/1.0-rc2/ns/phase.context.jsonld`.

:::include ./phase.context.jsonld :::

### Validation {data-cop-concept="validation"}

The Phase SHACL shape is published at `https://ujg.specs.openuji.org/tr/1.0-rc2/ns/phase.shape`.
