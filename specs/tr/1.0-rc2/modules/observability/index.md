...
- `observability.ttl`: ontology, published at `https://ujg.specs.openuji.org/tr/1.0-rc2/ns/observability`
- `observability.context.jsonld`: JSON-LD term mappings, published at `https://ujg.specs.openuji.org/tr/1.0-rc2/ns/observability.context.jsonld`
- `observability.shape.ttl`: SHACL validation rules, published at `https://ujg.specs.openuji.org/tr/1.0-rc2/ns/observability.shape`
...
`https://ujg.specs.openuji.org/tr/1.0-rc2/ns/observability`.
...
`https://ujg.specs.openuji.org/tr/1.0-rc2/ns/observability.context.jsonld`.
...
`https://ujg.specs.openuji.org/tr/1.0-rc2/ns/observability.shape`.
...
```json
{
  "@context": [
    ...
    "https://ujg.specs.openuji.org/tr/1.0-rc2/ns/l10n.context.jsonld",
    "https://ujg.specs.openuji.org/tr/1.0-rc2/ns/observability.context.jsonld"
  ],
