...
- `entry-binding.ttl`: ontology, published at `https://ujg.specs.openuji.org/tr/1.0-rc2/ns/entry-binding`
- `entry-binding.context.jsonld`: JSON-LD term mappings, published at `https://ujg.specs.openuji.org/tr/1.0-rc2/ns/entry-binding.context.jsonld`
- `entry-binding.shape.ttl`: SHACL validation rules, published at `https://ujg.specs.openuji.org/tr/1.0-rc2/ns/entry-binding.shape`

Examples in this page compose the shared baseline context `https://ujg.specs.openuji.org/tr/1.0-rc2/ns/context.jsonld`
...
`https://ujg.specs.openuji.org/tr/1.0-rc2/ns/entry-binding`. It is the authoritative structural definition
...
`https://ujg.specs.openuji.org/tr/1.0-rc2/ns/entry-binding.context.jsonld`. It provides the compact JSON-LD
...
`https://ujg.specs.openuji.org/tr/1.0-rc2/ns/entry-binding.shape`. It is the authoritative validation
...
{
  "@context": [
    "https://ujg.specs.openuji.org/tr/1.0-rc2/ns/context.jsonld",
    "https://ujg.specs.openuji.org/tr/1.0-rc2/ns/entry-binding.context.jsonld"
  ],
