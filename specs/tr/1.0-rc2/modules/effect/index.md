...
- `effect.ttl`: ontology, published at `https://ujg.specs.openuji.org/tr/1.0-rc2/ns/effect`
- `effect.context.jsonld`: JSON-LD term mappings, published at `https://ujg.specs.openuji.org/tr/1.0-rc2/ns/effect.context.jsonld`
- `effect.shape.ttl`: SHACL validation rules, published at `https://ujg.specs.openuji.org/tr/1.0-rc2/ns/effect.shape`

Examples in this page compose the shared baseline context
`https://ujg.specs.openuji.org/tr/1.0-rc2/ns/context.jsonld` with the Effect context. Examples that use
...
`https://ujg.specs.openuji.org/tr/1.0-rc2/ns/effect`.
...
`https://ujg.specs.openuji.org/tr/1.0-rc2/ns/effect.context.jsonld`.
...
`https://ujg.specs.openuji.org/tr/1.0-rc2/ns/effect.shape`.
...
```json
{
  "@context": [
    ...
    "https://ujg.specs.openuji.org/tr/1.0-rc2/ns/effect.context.jsonld",
    "https://ujg.specs.openuji.org/tr/1.0-rc2/ns/artifact.context.jsonld"
  ],
