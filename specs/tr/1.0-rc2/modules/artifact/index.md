...
- `artifact.ttl`: ontology, published at `https://ujg.specs.openuji.org/tr/1.0-rc2/ns/artifact`
- `artifact.context.jsonld`: JSON-LD term mappings, published at `https://ujg.specs.openuji.org/tr/1.0-rc2/ns/artifact.context.jsonld`
- `artifact.shape.ttl`: SHACL validation rules, published at `https://ujg.specs.openuji.org/tr/1.0-rc2/ns/artifact.shape`
...
`https://ujg.specs.openuji.org/tr/1.0-rc2/ns/artifact`.
...
`https://ujg.specs.openuji.org/tr/1.0-rc2/ns/artifact.shape`.
