...
- `condition.ttl`: ontology, published at `https://ujg.specs.openuji.org/tr/1.0-rc2/ns/condition`
- `condition.context.jsonld`: JSON-LD term mappings, published at `https://ujg.specs.openuji.org/tr/1.0-rc2/ns/condition.context.jsonld`
- `condition.shape.ttl`: SHACL validation rules, published at `https://ujg.specs.openuji.org/tr/1.0-rc2/ns/condition.shape`
...
[
  ...
  "https://ujg.specs.openuji.org/tr/1.0-rc2/ns/condition.context.jsonld"
]
```
...
`https://ujg.specs.openuji.org/tr/1.0-rc2/ns/condition`. It is the authoritative structural definition for
...
`https://ujg.specs.openuji.org/tr/1.0-rc2/ns/condition.context.jsonld`. It provides the compact JSON-LD term
...
`https://ujg.specs.openuji.org/tr/1.0-rc2/ns/condition.shape`. It is the authoritative validation artifact
