...
- `design-system.ttl`: ontology, published at `https://ujg.specs.openuji.org/tr/1.0-rc2/ns/design-system`
- `design-system.context.jsonld`: JSON-LD term mappings, published at `https://ujg.specs.openuji.org/tr/1.0-rc2/ns/design-system.context.jsonld`
- `design-system.shape.ttl`: SHACL validation rules, published at `https://ujg.specs.openuji.org/tr/1.0-rc2/ns/design-system.shape`

### Ontology {data-cop-concept="ontology"}

The normative Design System ontology is defined below and is published at
`https://ujg.specs.openuji.org/tr/1.0-rc2/ns/design-system`. It is the authoritative structural definition
...
`https://ujg.specs.openuji.org/tr/1.0-rc2/ns/design-system.context.jsonld`. It provides compact JSON-LD term
...
`https://ujg.specs.openuji.org/tr/1.0-rc2/ns/design-system.shape`. It is the authoritative validation
...
```json
{
  "@context": [
    ...
    "https://ujg.specs.openuji.org/tr/1.0-rc2/ns/graph.context.jsonld",
    "https://ujg.specs.openuji.org/tr/1.0-rc2/ns/surface.context.jsonld",
    "https://ujg.specs.openuji.org/tr/1.0-rc2/ns/design-system.context.jsonld"
  ],
