...
**RQ-2:** **Does gating the handover between phases lead to a better build that stays closer to the UJG?**
...
| Main question | Can a model hold the phase boundaries from guidance alone? | Does gating the handover produce a better build that stays closer to the UJG? |
...
> **Does gating the handover between phases lead to a better build that stays closer to the UJG?**
