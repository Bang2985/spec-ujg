...
* Map each `RuntimeEvent.stateRef` to its Blueprint owner (Journey / Composite path).
* Decide how to mark a step as “in-model” vs “jump” (based on Blueprint `Transition` + injected `OutgoingTransitionGroup`).
